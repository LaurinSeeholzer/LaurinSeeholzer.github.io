            ...
            r.VantaBase = class {
                    constructor(t = {}) {
                        ...
                        i("resize", this.resize),
                            ...
                            this.options.mouseControls && (i("scroll", this.windowMouseMoveWrapper),
                                i("mousemove", this.windowMouseMoveWrapper)),
                            this.options.touchControls && (i("touchstart", this.windowTouchWrapper),
        ...
        12: function(t, e, i) {
            ...
            class r extends s.b {
                ...
                onInit() {
                    ...
                    this.camera = new n.PerspectiveCamera(25, this.width / this.height, .01, 1e4),
                ...
                onUpdate() {
                    ...
                    for (let t = 0; t < this.points.length; t++) {
                        ...
                        if (l.scale.x = l.scale.y = l.scale.z = (.25 * (15 - u)).clamp(1, 100),
                            0 !== l.r) {
                ...
                onMouseMove(t, e) {
                    ...
                    i.tz = o * Math.sin(n),
                        i.tx = o * Math.cos(n),
                        i.ty = i.oy + 50 * (e - .5) * (this.options.mouseCoeffY || 1),
                        this.rayCaster,
                        this.rcMouseX = 2 * t - 1,
                        this.rcMouseY = 2 * -t + 1
                }
